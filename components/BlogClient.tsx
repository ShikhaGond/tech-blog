...
export default function BlogClient({ blogs }: { blogs: BlogPost[] }) {
  ...
  return (
    <>
      ...
      <header className="bg-gradient-to-r from-gray-900 to-black text-white">
        <div className="max-w-6xl mx-auto px-4 py-5 flex justify-between items-center">
          ...
          <button
            ...
            className="border px-3 py-1 rounded text-sm bg-white/10 hover:bg-white/20 transition"
      ...
      {selectedBlog && (
        <div
          className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50 transition-opacity"
